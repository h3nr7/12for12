...
// playerData.reduce((prev, next, i) => {
//      if(!prev) prev = { [prev.invitedProfile.id]: {...prev.invitedProfile} }
//      prev = {...prev, [next.invitedProfile.id]: {...next.invitedProfile}};
//      return prev;
//  }, {});


// export const playerData: Array<{}> = [
//     {
//         "invitedProfile": {
//             "id": 1930178,
//             "firstName": "Sam",
